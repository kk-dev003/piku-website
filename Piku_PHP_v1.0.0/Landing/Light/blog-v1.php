                ...
                <div class="row">
                    <div class="col-xxl-10 m-auto">
                        <article class="blog-meta-one mb-70 lg-mb-50">
                            <div class="media">
                                <img src="assets/images/blog/blog_img_01.jpg" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                ...
                                <a href="blog-details.php" class="read-more rounded-circle tran3s"><i class="bi bi-arrow-up-right"></i></a>
                            </div>
                            <!-- /.post-meta -->
                        </article>
                        <!-- /.blog-meta-one -->
                        ...
                        <article class="blog-meta-one mb-70 lg-mb-50">
                            <div class="media">
                                <img src="assets/images/blog/blog_img_02.jpg" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <ul class="style-none tags d-flex flex-wrap">
                        ...
                        <article class="blog-meta-one mb-70 lg-mb-50">
                            <div class="media">
                                <img src="assets/images/blog/blog_img_03.jpg" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <ul class="style-none tags d-flex flex-wrap">
                        ...
                        <article class="blog-meta-one mb-70 lg-mb-50">
                            <div class="media">
                                <img src="assets/images/blog/blog_img_04.jpg" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <ul class="style-none tags d-flex flex-wrap">
                        ...
                        <article class="blog-meta-one mb-70 lg-mb-50">
                            <div class="media">
                                <img src="assets/images/blog/blog_img_05.jpg" alt="" class="w-100">
                            </div>
                            <div class="post-meta position-relative z-1">
                                <ul class="style-none tags d-flex flex-wrap">
