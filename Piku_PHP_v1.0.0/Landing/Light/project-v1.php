	...
	<div class="main-page-wrapper dark-bg p-30">
		...
		<div class="inner-banner-two bg-one border-30 z-1 pt-100 lg-pt-60 pb-90 lg-pb-50 mt-30 lg-mt-20 position-relative">
			<div class="container">
                ...
                <div class="filter-nav-one mt-50 lg-mt-30">
		...
		=====================================================
		-->
		<div class="project-section-two mt-30 lg-mt-20">
			<div id="isotop-gallery-wrapper" class="grid-2column">
                <div class="grid-sizer"></div>
                <div class="isotop-item application brand mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="assets/images/media/img_38.jpg" alt="" class="w-100 media-img tran3s">
                        <a href="project-details.php" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                <!-- /.isotop-item -->
                <div class="isotop-item design mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="assets/images/media/img_39.jpg" alt="" class="w-100 media-img tran3s">
                        <a href="project-details.php" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                <!-- /.isotop-item -->
                <div class="isotop-item market dev mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="assets/images/media/img_40.jpg" alt="" class="w-100 media-img tran3s">
                        <a href="project-details.php" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                <!-- /.isotop-item -->
                <div class="isotop-item market brand mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="assets/images/media/img_41.jpg" alt="" class="w-100 media-img tran3s">
                        <a href="project-details.php" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                <!-- /.isotop-item -->
                <div class="isotop-item application dev mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="assets/images/media/img_42.jpg" alt="" class="w-100 media-img tran3s">
                        <a href="project-details.php" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                ...
                <div class="isotop-item design mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="assets/images/media/img_43.jpg" alt="" class="w-100 media-img tran3s">
                        <a href="project-details.php" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
