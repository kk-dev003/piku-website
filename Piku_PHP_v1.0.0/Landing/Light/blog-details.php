					...
					<div class="col-xl-11 m-auto">
						<div class="pe-xl-5 ps-xl-5">
							<article class="blog-details-post">
								...
								<div class="bottom-widget d-lg-flex align-items-center justify-content-between">
                                    ...
                                    <ul class="d-flex share-icon align-items-center style-none pt-20">
                                        <li>Share</li>
                                        <li><a href="blog-v1.php"><i class="bi bi-facebook"></i></a></li>
                                        <li><a href="blog-v1.php"><i class="bi bi-twitter"></i></a></li>
                                        <li><a href="blog-v1.php"><i class="bi bi-instagram"></i></a></li>
                                    </ul>
                                </div>
							</article>
							...
							<div class="blog-comment-form">
								...
								<p class="text-center"><a href="#"><a href="login.php">Login</a> to post your comment or <a href="signup.php">signup</a> if you dont have any account</p>
