                            ...
                            <div class="col-lg-8">
                                <article class="blog-meta-two mb-90 lg-mb-50">
                                    <figure class="media position-relative" style="background-image: url(assets/images/blog/blog_img_06.jpg);">
                                        <a href="blog-details.php" class="stretched-link date tran3s">13 Apr</a>
                                    </figure>
                                    <div class="post-meta">
                                        <div class="post-info">Rashed Ka . 6 min . Finance </div>
                                        <div class="d-flex justify-content-between align-items-start flex-wrap">
                                            <a href="blog-details.php" class="blog-title"><h4>Spending Habits, 13 Tips for grow Your Money.</h4></a>
                                            <a href="blog-details.php" class="round-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i class="bi bi-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                                    <!-- /.post-meta -->
                                </article>
                                ...
                                <article class="blog-meta-two mb-70 lg-mb-40">
                                    <figure class="media position-relative" style="background-image: url(assets/images/blog/blog_img_07.jpg);">
                                        <a href="blog-details.php" class="stretched-link date tran3s">09 FEB</a>
                                    </figure>
                                    <div class="post-meta">
                                        <div class="post-info">Jannat Firlo . 5 min . Travel</div>
                                        <div class="d-flex justify-content-between align-items-start flex-wrap">
                                            <a href="blog-details.php" class="blog-title"><h4>Our Travel Card Makes
                                                you Happy.</h4></a>
                                            <a href="blog-details.php" class="round-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i class="bi bi-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                                ...
                                <article class="blog-meta-three mb-70 lg-mb-40">
                                    <div class="post-meta">
                                        <div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="assets/images/icon/icon_16.svg" alt="" class="lazy-img"></div>
                                        <a href="blog-details.php" class="blog-title"><h4>"Budget your desires, investing knowledge, &amp; let compound interest build your future."</h4></a>
                                    </div>
                                ...
                                <article class="blog-meta-two mb-90 lg-mb-50">
                                    ...
                                    <div class="post-meta">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start flex-wrap">
                                            <a href="blog-details.php" class="blog-title"><h4>Manage your Online Banking & Get Rewarded</h4></a>
                                            <a href="blog-details.php" class="round-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i class="bi bi-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                                    <!-- /.post-meta -->
                                ...
                                <article class="blog-meta-two mb-90 lg-mb-50">
                                    <figure class="media position-relative" style="background-image: url(assets/images/blog/blog_img_09.jpg);">
                                        <a href="blog-details.php" class="stretched-link date tran3s">24 Dec</a>
                                    </figure>
                                    <div class="post-meta">
                                        <div class="post-info">Jubayer Hasan . 3 min . Business</div>
                                        <div class="d-flex justify-content-between align-items-start flex-wrap">
                                            <a href="blog-details.php" class="blog-title"><h4>It’s easy to Buildup your Business with us</h4></a>
                                            <a href="blog-details.php" class="round-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i class="bi bi-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                                    <!-- /.post-meta -->
							...
							<div class="col-lg-4">
								<div class="blog-sidebar md-mt-60 ps-xl-4">
									...
									<div class="blog-recent-news mt-60 lg-mt-40">
										...
										<article class="recent-news">
											<div class="post-data">
												...
												<a href="blog-details.php" class="blog-title"><h3>It’s easy to Buildup your Business with us</h3></a>
											</div>
										</article>
										<article class="recent-news">
											<div class="post-data">
												<div class="date">17 Aug 2023</div>
												<a href="blog-details.php" class="blog-title"><h3>Make your life easier with our Piku CRM App</h3></a>
											</div>
										</article>
										<article class="recent-news">
											<div class="post-data">
												<div class="date">06 Dec 2023</div>
												<a href="blog-details.php" class="blog-title"><h3>Introducing new tools for your design.</h3></a>
											</div>
										</article>
									</div>
									<!-- /.blog-recent-news -->
									...
									<div class="contact-banner text-center mt-50 lg-mt-30">
										...
										<a href="contact.php" class="tran3s fw-500">Let’s Talk</a>
									</div>
									<!-- /.contact-banner -->
								</div>
								<!-- /.blog-sidebar -->
