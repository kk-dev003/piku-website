			...
			<div class="container position-relative">
				<div class="row">
					<div class="col-lg-7 col-md-7">
						<p class="fs-24 fw-500 text-dark mb-10 wow fadeInUp">Apply Now!</p>
						...
						<div class="row">
							<div class="col-xxl-8 col-lg-10">
								<p class="fs-24 text-dark pt-25 pb-30 lg-pb-20 xs-pb-10 wow fadeInUp" data-wow-delay="0.1s">Piku delivered blazing performance, fast striking word solution</p>
							</div>
						</div>
						...
						<p class="fs-22 pt-100 md-pt-50 md-pb-20"><span class="fw-500 text-dark text-decoration-underline">Join 27,000+</span> companies who’ve reached </p>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-xxl-7 col-lg-6 order-lg-last">
						<div class="ps-lg-5 ms-xxl-4 md-mb-60">
							...
							<p class="fs-28 text-dark fw-500 mt-40 md-mt-20">Piku offers virtual debit cards, FDIC-insured USD accounts through City Savings.</p>
							...
							<a href="pricing-v1.php" class="btn-two xl">Order Your Card Now!</a>
						</div>
					</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6 wow fadeInLeft">
						<div class="title-one mb-30 mt-50">
							<h2>Globally  Send Money <span class="d-inline-block position-relative">with <img src="assets/images/shape/shape_03.svg" alt="" class="d-inline-block"></span> <br> Low Fees</h2>
						</div>
				...
				<div class="row align-items-center mt-100 md-mt-30">
					<div class="col-lg-6 wow fadeInRight order-lg-last">
						<div class="ps-xl-5">
							<div class="title-one mb-30 mt-50">
								<h2>Withdraw money from <span class="d-inline-block position-relative">an ATM <img src="assets/images/shape/shape_03.svg" alt="" class="d-inline-block"></span></h2>
							</div>
			...
			<div class="feedback-slider-one">
				<div class="item">
					<div class="feedback-block-one bg-white border-30">
						...
						<div class="d-sm-flex align-items-center justify-content-between">
							<p class="m0"><span class="fw-500 text-dark fs-20">Rashed kabir,</span> Lead Designser, Monday</p>
				...
				<div class="item">
					<div class="feedback-block-one bg-white border-30">
						...
						<div class="d-sm-flex align-items-center justify-content-between">
							<p class="m0"><span class="fw-500 text-dark fs-20">Jon Cooper, </span> Art Director, Slack</p>
							<ul class="style-none d-flex rating">
								<li><i class="bi bi-star-fill"></i></li>
								<li><i class="bi bi-star-fill"></i></li>
								<li><i class="bi bi-star-fill"></i></li>
		...
		<div class="faq-section-one bg-four position-relative z-1 pt-150 lg-pt-80 pb-120 lg-pb-80 border-30 mb-30 lg-mb-20">
			<div class="container">
				...
				<div class="text-center mt-60 lg-mt-40">
					...
					<a href="contact-v1.php" class="btn-two xl">Contact us</a>
				</div>
			</div>
