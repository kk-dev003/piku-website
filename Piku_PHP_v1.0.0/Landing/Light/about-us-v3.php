...
<body>
	<div class="main-page-wrapper">
						...
						<div class="right-widget order-lg-3 ms-auto me-3 me-lg-0">
							<ul class="d-flex align-items-center style-none">
								...
								<li class="d-none d-sm-inline-block">
									<a href="signup.php" class="login-btn-one fw-500 d-flex align-items-center tran3s"><img src="assets/images/icon/icon_18.svg" alt="" class="me-2"> <span>My Account</span></a>
                                </li>
							</ul>
						</div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 order-lg-last ms-auto">
                            <div class="title-ten pe-xxl-5">
                                <div class="fs-22 text-dark mb-15">About us</div>
        ...
        <div class="mt-180 xl-mt-150 lg-mt-100">
            <div class="container">
				<div class="fs-24 fw-500 text-dark text-center mb-20">Used by over 12,000+ brands all over the world</div>
