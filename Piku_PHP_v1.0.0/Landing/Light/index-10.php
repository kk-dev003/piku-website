                ...
                <div class="container lg">
                    <div class="row">
                        <div class="col-xxl-5 col-xl-7 col-lg-8 col-md-10">
                            <h1 class="hero-heading font-Montserrat wow fadeInUp">Opt-in for Cyber Safety, stay secure.</h1>
                            ...
                            <ul class="d-flex align-items-center flex-wrap style-none btn-group wow fadeInUp" data-wow-delay="0.2s">
                                <li><a href="index.php" class="active"><img src="assets/images/icon/icon_62.svg" alt=""> Download for Mac</a></li>
                                <li><a href="index.php"><img src="assets/images/icon/icon_63.svg" alt=""> Download for Windows</a></li>
                            </ul>
                            ...
                            <div class="fs-24 wow fadeInUp" data-wow-delay="0.4s"><span class="fw-500 text-dark text-decoration-underline">Trusted by 27,000+</span> customers around the world</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div class="card-style-thirteen d-flex w-100 mt-35">
                                <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="assets/images/icon/icon_64.svg" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-style-thirteen d-flex w-100 mt-35">
                                <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="assets/images/icon/icon_65.svg" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div class="card-style-thirteen d-flex w-100 mt-35">
                                <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="assets/images/icon/icon_66.svg" alt=""></div>
                                <div class="text">
                ...
                <div class="row gx-xxl-5 mt-30 lg-mt-10">
                    <div class="col-lg-4">
                        <div class="card-style-fourteen mt-35">
                            ...
                            <a href="service-details.php" class="cta-btn border-2 border-top border-start border-dark tran3s d-flex align-items-center justify-content-center"><img src="assets/images/icon/icon_70.svg" alt=""></a>
                        </div>
                        <!-- /.card-style-fourteen -->
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="pr-table-wrapper d-flex flex-wrap">
                    ...
                    <div class="pr-column popular">
                        <div class="pr-header text-center">
                            ...
                            <div><span class="fw-500 text-dark">Save ~20%</span> when billed yearly</div>
                    ...
                    <div class="pr-column">
                        <div class="pr-header text-center">
                            ...
                            <div><span class="fw-500 text-dark">Save ~30%</span> when billed yearly</div>
                            <a href="#" class="btn-nineteen w-100 mt-50 lg-mt-30">Add To Cart</a>
                        </div>
                        <ul class="feature-list style-none">
                            <li><span>10 gb Storage</span></li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-lg-last ms-auto">
                            <div class="title-ten pe-xl-5 me-xl-5">
                                <div class="fs-22 text-dark mb-15">Threat Protection</div>
                ...
                <div class="block-feature mt-180 lg-mt-150 md-mt-120">
                    <div class="row align-items-center">
                        <div class="col-lg-6 me-auto">
                            <div class="title-ten">
                                <div class="fs-22 text-dark mb-15">Secure VPN</div>
                ...
                <div class="row gx-xxl-5">
                    <div class="col-lg-4">
                        <div class="card-style-fifteen text-center mt-25">
                            <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="assets/images/icon/icon_74.svg" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="card-style-fifteen text-center mt-25">
                            <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="assets/images/icon/icon_75.svg" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="card-style-fifteen text-center mt-25">
                            <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="assets/images/icon/icon_76.svg" alt=""></div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-7">
                            ...
                            <a href="index.php" class="btn-nineteen">Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
