			...
			<div class="container lg">
                <div class="row">
                    <div class="col-lg-6 col-md-8">
                        ...
                        <p class="fs-24 text-dark pt-35 lg-pt-30 pb-30 pe-xxl-5 wow fadeInUp" data-wow-delay="0.1s">Guaranteeing fast, secure, always-online site for trust from visitors, search engines.</p>
                        <a href="about-us-v1.php" class="btn-eighteen">Start Now</a>
                        <p class="fs-22 pt-40 lg-pt-20">From <span class="fw-500 text-dark">$3.99/mo.</span> <del>Regular $17.99/mo.</del>  exc VAT</p>
                    </div>
                </div>
				...
				<div class="row gx-xxl-5">
					<div class="col-lg-4">
						<div class="card-style-eleven">
							...
							<p class="m0">Start from <span class="fw-500 text-dark">$2.99/mo</span></p>
			...
			<div class="container lg">
				<div class="row">
                    <div class="col-xl-4 col-lg-6 m-auto m-xl-0 text-center text-xl-start">
						...
						<div class="fs-20 fw-500 text-dark mt-55 lg-mt-40 mb-15">Billing Cycle</div>
									...
									<div class="col-lg-6 d-flex">
										<div class="pr-column w-100">
											<div class="pr-header text-center mb-25">
												...
												<div class="info2 fs-20">Reguler price <del class="fw-500 text-dark">$13.99</del></div>
									...
									<div class="col-lg-6 d-flex">
										<div class="pr-column w-100 md-mt-30">
											<div class="pr-header text-center mb-25">
												...
												<div class="info2 fs-20">Reguler price <del class="fw-500 text-dark">$29.99</del></div>
				...
				<div class="wrapper">
					...
					<div class="row">
						...
						<div class="col-xl-5 col-lg-6">
							<p class="fs-24 text-dark md-mt-30">Elevate your online business success with our expert guidance & reliable hosting services. Let's win together!"</p>
						</div>
					</div>
				</div>
			</div>
