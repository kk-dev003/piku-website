				...
				<div class="row">
					<div class="col-lg-7 me-auto">
						<div class="pe-xxl-5">
							...
							<blockquote class="p0">Piku is the leading AI solution for optimizing B2B SaaS campaigns, ensuring unparalleled success  and efficiency.</blockquote>
			...
			<div class="container">
				<div class="position-relative">
					...
					<div class="section-btn text-center md-mt-60">
						<a href="team-v1.php" class="btn-twenty">See All Members</a>
					</div>
				</div>
			</div>
