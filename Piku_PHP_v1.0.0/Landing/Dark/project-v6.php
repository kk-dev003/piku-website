...
<body>
	<div class="main-page-wrapper dark-bg-two">
		...
		=====================================================
		-->
		<div class="project-section-six position-relative mt-225 lg-mt-150 mb-150 lg-mb-60">
			<div class="container">
                <div class="title-two mb-55 lg-mb-40">
                    <h2>Our Projects</h2>
                </div>
			</div>
                ...
                <div class="project-slider-one">
                    <div class="item">
                        <div class="project-block-five">
                            <img src="assets/images/media/img_67.jpg" alt="" class="media-img w-100">
                            <div class="position-relative">
                                <span>UI DESIGN</span>
                                <h4>Website — Banner Exploration</h4>
                    ...
                    <div class="item">
                        <div class="project-block-five">
                            <img src="assets/images/media/img_68.jpg" alt="" class="media-img w-100">
                            <div class="position-relative">
                                <span>Mobile app</span>
                                <h4>App — Finance & Banking</h4>
                                <a href="project-details.php" class="stretched-link"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="project-block-five">
                            <img src="assets/images/media/img_69.jpg" alt="" class="media-img w-100">
                            <div class="position-relative">
                                <span>Application</span>
                                <h4>Kindergarten — Online school</h4>
                                <a href="project-details.php" class="stretched-link"></a>
                            </div>
                        </div>
                    </div>
