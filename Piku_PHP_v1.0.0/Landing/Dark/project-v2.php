...
<body>
	<div class="main-page-wrapper dark-bg-two">
		...
		=====================================================
		-->
		<div class="project-section-three pt-225 lg-pt-150 mb-150 lg-mb-80">
			<div class="container">
                <div class="title-two text-center mb-55 lg-mb-30">
                    <h2>Our Projects</h2>
                </div>

                <div class="filter-nav-two">
				...
				<div id="isotop-gallery-wrapper" class="grid-2column">
                    ...
                    <div class="isotop-item application brand mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="assets/images/media/img_44.jpg" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                ...
                                <a href="project-details.php" class="stretched-link"></a>
                            </div>
                        </div>
                        <!-- /.project-block-three -->
                    </div>
                    <!-- /.isotop-item -->
                    <div class="isotop-item design mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="assets/images/media/img_45.jpg" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                                    <h6>UI/UX — Case Studies & Branding</h6>
                                    <span>UI/UX</span>
                                </div>
                                <img src="assets/images/icon/icon_93.svg" alt="" class="mt-2 ms-auto">
                                <a href="project-details.php" class="stretched-link"></a>
                    ...
                    <!-- /.isotop-item -->
                    <div class="isotop-item market dev mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="assets/images/media/img_46.jpg" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                    ...
                    <!-- /.isotop-item -->
                    <div class="isotop-item market brand mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="assets/images/media/img_47.jpg" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                    ...
                    <!-- /.isotop-item -->
                    <div class="isotop-item application dev mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="assets/images/media/img_48.jpg" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                    ...
                    <div class="isotop-item design mt-50 lg-mt-30">
                        <div class="project-block-three position-relative z-1">
                            <img src="assets/images/media/img_49.jpg" alt="" class="w-100 media-img tran3s">
                            <div class="position-relative d-flex justify-content-between align-items-start pt-35">
                                <div class="pe-3">
                                    <h6>Print — Calendar Design</h6>
                                    <span>Print Design</span>
                                </div>
                                <img src="assets/images/icon/icon_93.svg" alt="" class="mt-2 ms-auto">
                                <a href="project-details.php" class="stretched-link"></a>
