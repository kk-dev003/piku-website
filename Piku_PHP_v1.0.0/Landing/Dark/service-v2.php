...
<body>
	<div class="main-page-wrapper dark-bg-two">
                        ...
                        <div class="card-style-two tran3s w-100">
                            <div class="wrapper tran3s d-flex flex-column h-100 position-relative">
                                <div class="d-flex justify-content-between align-items-center mb-160 xl-mb-120 lg-mb-80 position-relative z-1">
                                    ...
                                    <img src="assets/images/shape/shape_86.svg" alt="" class="shapes pointer">
                                    <div class="icon tran3s rounded-circle d-flex align-items-center justify-content-center"><img src="assets/images/icon/icon_07.svg" alt=""></div>
                                </div>
                                <p class="font-manrope tran3s mt-auto">AI refines language, suggests, applies precise verbs for polished communication effortlessly.</p>
                                <a href="service-details.php" class="stretched-link"></a>
		...
		<div class="block-feature-six position-relative z-2 pt-140 lg-pt-80 pb-130 lg-pb-80">
            ...
            <img src="assets/images/shape/shape_87.svg" alt="" class="shapes bg-shape-two">
		</div>
		<!-- /.block-feature-six -->
				...
				<div class="row">
					<div class="col-12">
						<div class="logo-wrapper d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between">
							<div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_69.png" alt=""></div>
							<div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_70.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_71.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_72.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_73.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_74.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_75.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_76.png" alt=""></div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-10 m-auto">
						<div class="logo-wrapper d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between">
							<div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_77.png" alt=""></div>
							<div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_78.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_79.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_80.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_69.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_70.png" alt=""></div>
                            <div class="logo d-flex align-items-center justify-content-center"><img src="assets/images/logo/p_logo_71.png" alt=""></div>
						</div>
        ...
        <div class="feedback-section-eleven position-relative z-1 mt-150 lg-mt-80 pb-80 lg-pb-10">
            ...
            <img src="assets/images/shape/shape_88.svg" alt="" class="shapes bg-shape">
        </div>
