	...
	<div class="main-page-wrapper dark-bg-three">
					...
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
							<ul class="d-flex align-items-center style-none">
								<li>
									<a href="login.php" class="login-btn-four fw-500 d-flex align-items-center tran3s"><img src="assets/images/icon/icon_26.svg" alt="" class="me-2"> <span>Login</span></a>
                                </li>
						...
						<nav class="navbar navbar-expand-lg p0 order-lg-2 ms-lg-5">
							...
							<div class="collapse navbar-collapse ms-lg-5" id="navbarNav">
								<ul class="navbar-nav align-items-lg-center">
									<li class="d-block d-lg-none"><div class="logo"><a href="index.php" class="d-block"><img src="assets/images/logo/logo_08.svg" alt=""></a></div></li>
		...
		<div class="hero-banner-five z-1 position-relative">
			<div class="wrapper position-relative z-1 pt-200 md-pt-150 pb-130 lg-pb-80">
                ...
                <img src="assets/images/assets/card_09.png" alt="" class="illustration wow fadeInRight">
				...
				<div class="row">
					<div class="col-lg-4">
                        <div class="card-style-seven position-relative text-center mt-30 pb-45 lg-pb-30">
                            <img src="assets/images/icon/icon_28.svg" alt="" class="icon m-auto">
                    ...
                    <div class="col-lg-4">
                        <div class="card-style-seven position-relative text-center mt-30 pb-45 lg-pb-30">
                            <img src="assets/images/icon/icon_29.svg" alt="" class="icon m-auto">
                    ...
                    <div class="col-lg-4">
                        <div class="card-style-seven position-relative text-center mt-30 pb-45 lg-pb-30">
                            <img src="assets/images/icon/icon_30.svg" alt="" class="icon m-auto">
					...
					<div class="row">
						<div class="col-lg-8 d-flex">
							<div class="feature-block block-one w-100 mt-30" style="background: #FFEB80;">
								...
								<img src="assets/images/assets/card_10.png" alt="" class="w-100 mt-70 md-mt-40">
								<img src="assets/images/shape/shape_43.svg" alt="" class="shapes shape_01">
							</div>
							<!-- /.feature-block -->
						</div>
						<div class="col-lg-4 d-flex">
							<div class="feature-block block-one w-100 mt-30" style="background: #76FFCE;">
								...
								<img src="assets/images/assets/card_11.png" alt="" class="w-100 mt-40">
								<img src="assets/images/shape/shape_44.svg" alt="" class="shapes shape_02">
							</div>
							<!-- /.feature-block -->
						</div>
						<div class="col-12 d-flex">
							<div class="feature-block block-one w-100 mt-50 lg-mt-30 pe-0" style="background: #D3A7FF;">
								<div class="row">
									...
									<div class="col-lg-6">
										<img src="assets/images/assets/card_12.png" alt="" class="ms-auto mt-20 md-mt-40 mb-60 md-mb-10">
									</div>
								</div>
								<img src="assets/images/shape/shape_45.svg" alt="" class="shapes shape_03">
							</div>
							<!-- /.feature-block -->
						</div>
					</div>
		...
		<div class="app-integration-one mt-170 xl-mt-150 lg-mt-80">
			...
			<div class="logo-wrapper">
				<div class="partner-logo-two">
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #91C400;"><img src="assets/images/logo/p_logo_40.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #9F54FF;"><img src="assets/images/logo/p_logo_41.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #31D9EC;"><img src="assets/images/logo/p_logo_42.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #FE65E5;"><img src="assets/images/logo/p_logo_43.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #4EE265;"><img src="assets/images/logo/p_logo_44.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #F5DC00;"><img src="assets/images/logo/p_logo_45.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #FF7F54;"><img src="assets/images/logo/p_logo_46.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #24CAFF;"><img src="assets/images/logo/p_logo_42.png" alt=""></div>
					</div>
					<div class="item">
						<div class="logo-box d-flex align-items-center justify-content-center" style="background: #FE65E5;"><img src="assets/images/logo/p_logo_43.png" alt=""></div>
					</div>
		...
		<div class="feedback-section-five position-relative z-1 mt-150 lg-mt-80">
						...
						<div class="col-lg-6">
							<div class="feedback-wrapper md-mt-50">
								<div class="feedback-block" style="background: #FFDA7C;">
									<img src="assets/images/logo/p_logo_49.png" alt="" class="logo">
								...
								<div class="feedback-block" style="background: #FF90ED;">
									<img src="assets/images/logo/p_logo_48.png" alt="" class="logo">
									<blockquote>“Quick solutions coupled with great performance—a recommendation that's unequivocal”</blockquote>
									<div class="d-flex align-items-center justify-content-between">
										<div class="rating">4.8 Excellent</div>
										<ul class="style-none d-flex">
								...
								<div class="feedback-block" style="background: #85F8F1;">
									<img src="assets/images/logo/p_logo_47.png" alt="" class="logo">
									<blockquote>“Quick solutions coupled with great performance—a recommendation that's unequivocal”</blockquote>
									<div class="d-flex align-items-center justify-content-between">
										<div class="rating">4.8 Excellent</div>
										<ul class="style-none d-flex">
			...
			<!-- /.wrapper -->
			<img src="assets/images/shape/shape_46.svg" alt="" class="shapes shape_01">
			<img src="assets/images/shape/shape_47.svg" alt="" class="shapes shape_02">
		</div>
		<!-- /.feedback-section-five -->
						...
						<div class="row gx-xxl-5">
							<div class="col-lg-4 d-flex">
								<div class="pr-column w-100 mt-30" style="border-color: #20E8C4;">
									...
									<!-- /.pr-header -->
                                    <a href="#" class="btn-eleven w-100 d-flex justify-content-between align-items-center">Start Free Trial<span class="icon d-flex align-items-center justify-content-center"><img src="assets/images/icon/icon_32.svg" alt=""></span></a>
									<ul class="style-none package-feature mt-60 lg-mt-50">
										<li>Web Design</li>
										<li>Front-End Coding</li>
										<li>Mobile App Development</li>
									</ul>
									<img src="assets/images/shape/shape_48.svg" alt="" class="shapes shape">
								</div>
								<!-- /.pr-column -->
							</div>
							<div class="col-lg-4 d-flex">
								<div class="pr-column w-100 mt-30" style="border-color: #FFC736;">
									...
									<img src="assets/images/shape/shape_49.svg" alt="" class="shapes shape">
								</div>
								<!-- /.pr-column -->
							</div>
							<div class="col-lg-4 d-flex">
								<div class="pr-column w-100 mt-30" style="border-color: #FF56BB;">
									...
									<img src="assets/images/shape/shape_50.svg" alt="" class="shapes shape">
								</div>
								<!-- /.pr-column -->
							</div>
						</div>
			...
			<div class="container">
				<div class="row">
                    <div class="col-lg-5">
						...
						<a href="contact-v2.php" class="btn-eleven style-two">Contact us</a>
                    </div>
					<div class="col-lg-7">
