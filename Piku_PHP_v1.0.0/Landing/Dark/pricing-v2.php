			...
			<div class="wrapper text-center position-relative z-1 pt-200 xl-pt-150 pb-120 xl-pb-100 lg-pb-80">
                <div class="container">
                    ...
                    <ul class="style-none d-flex align-items-center justify-content-center">
                        <li><a href="index-5.php">Home</a></li>
                        <li>/</li>
                        <li>Pricing</li>
                    </ul>
                </div>
						...
						<div class="row gx-xxl-5">
							<div class="col-lg-4 d-flex">
								<div class="pr-column w-100 mt-30" style="border-color: #20E8C4;">
									...
									<!-- /.pr-header -->
                                    <a href="index.php" class="btn-eleven w-100 d-flex justify-content-between align-items-center">Start Free Trial<span class="icon d-flex align-items-center justify-content-center"><img src="assets/images/icon/icon_32.svg" alt=""></span></a>
