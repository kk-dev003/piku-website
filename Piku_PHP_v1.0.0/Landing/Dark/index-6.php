...
<body>
	<div class="main-page-wrapper">
		...
		<div class="hero-banner-six z-1 position-relative">
			<div class="wrapper position-relative z-1 pt-250 xl-pt-200 md-pt-150 pb-180 xl-pb-100 lg-pb-50">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-7">
                            ...
                            <div class="d-flex align-items-center flex-wrap wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <a class="btn-sixteen mt-10" href="contact-v2.php">Contact</a>
                            </div>

							<div class="d-flex align-items-center mt-75 md-mt-40">
								<img src="assets/images/assets/avatar.png" alt="">
								<div class="rating">
                ...
                <div class="illustration">
					<img src="assets/images/assets/card_13.png" alt="" class="w-100">
					<img src="assets/images/assets/card_13.1.png" alt="" class="shapes shape_01">
					<img src="assets/images/assets/card_13.2.png" alt="" class="shapes shape_02">
					<img src="assets/images/assets/card_13.3.png" alt="" class="shapes shape_03">
				</div>
				<img src="assets/images/assets/bg_09.png" alt="" class="shapes bg-shape">
            </div>
		</div>
		<!-- /.hero-banner-six -->
		...
		<div class="fancy-banner-six position-relative z-1 mt-60 lg-mt-30">
			...
			<img src="assets/images/shape/shape_51.svg" alt="" class="shapes shape_01">
			<img src="assets/images/shape/shape_52.svg" alt="" class="shapes shape_02">
			<img src="assets/images/shape/shape_53.svg" alt="" class="shapes shape_03">
		</div>
		<!-- /.fancy-banner-six -->
				...
				<div class="row gx-xxl-5">
					<div class="col-lg-4">
						<div class="card-style-eight text-center mt-35 wow fadeInUp">
							<img src="assets/images/icon/icon_34.png" alt="" class="icon m-auto">
							<h5>Open Account</h5>
					...
					<div class="col-lg-4">
						<div class="card-style-eight text-center mt-35 wow fadeInUp" data-wow-delay="0.1s">
							<img src="assets/images/icon/icon_35.png" alt="" class="icon m-auto">
							<h5>Dashboard</h5>
							<p class="ps-xxl-4 pe-xxl-4">You design, we generate the code — for everything from fully custom layouts to</p>
						</div>
						<!-- /.card-style-eight -->
					...
					<div class="col-lg-4">
						<div class="card-style-eight text-center mt-35 wow fadeInUp" data-wow-delay="0.2s">
							<img src="assets/images/icon/icon_36.png" alt="" class="icon m-auto">
				...
				<div class="row gx-xxl-5">
							...
							<div class="row align-items-center">
								<div class="col-lg-5 order-lg-last">
									<div class="ps-xxl-4 pe-xxl-3">
										...
										<a href="about-us-v3.php" class="btn-seven">Learn More</a>
									</div>
								</div>
								<div class="col-lg-7">
									<img src="assets/images/assets/card_14.png" alt="" class="me-auto ms-auto">
								</div>
							</div>
					...
					<div class="col-lg-6 d-flex">
						<div class="feature-block block-one w-100 mt-50 lg-mt-30 pt-55 lg-pt-30">
							...
							<div class="position-relative">
								<img src="assets/images/assets/card_15.png" alt="" class="me-auto ms-auto">
								<img src="assets/images/shape/shape_54.svg" alt="" class="shapes shape_01">
							</div>
						</div>
						<!-- /.feature-block -->
					</div>
					<div class="col-lg-6 d-flex">
						<div class="feature-block block-one w-100 mt-50 lg-mt-30 pt-55 lg-pt-30 md-pb-40">
							...
							<div class="position-relative">
								<img src="assets/images/assets/card_16.png" alt="" class="me-auto ms-auto card-three">
							</div>
						</div>
						<!-- /.feature-block -->
					</div>
					<div class="col-12">
						<div class="feature-block block-one w-100 mt-50 lg-mt-30 pt-70 lg-pt-40">
							...
							<img src="assets/images/assets/card_17.png" alt="" class="me-auto ms-auto mt-70 xs-mt-40">
							<img src="assets/images/assets/card_17.1.png" alt="" class="shapes shape_02">
							<img src="assets/images/shape/shape_55.svg" alt="" class="shapes shape_03">
						</div>
						<!-- /.feature-block -->
					</div>
				</div>
		...
		<div class="feedback-section-six text-center position-relative z-1 mt-200 xl-mt-150 lg-mt-100">
			<div class="container">
				<img src="assets/images/assets/card_18.png" alt="" class="mb-50 lg-mb-10">
				...
				<img src="assets/images/assets/card_19.png" alt="" class="mt-50 lg-mt-10">
				<img src="assets/images/assets/bg_10.png" alt="" class="shapes shape_01">
				<img src="assets/images/shape/shape_56.svg" alt="" class="shapes shape_02">
				<img src="assets/images/shape/shape_57.svg" alt="" class="shapes shape_03">
			</div>
		</div>
		<!-- /.feedback-section-six -->
						...
						<div class="col-lg-4 d-flex mt-35">
							<div class="pr-column w-100 d-flex flex-column">
								...
								<ul class="style-none package-feature mt-50 lg-mt-20 mb-35">
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> 60-day chat history</li>
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> Basic widget customization</li>
									<li><img src="assets/images/icon/cross.svg" alt="" class="icon"> Ticketing system</li>
									<li><img src="assets/images/icon/cross.svg" alt="" class="icon"> Data security</li>
								</ul>
								<div class="mt-auto"><a href="#" class="btn-seven w-100">Subscribe Now</a></div>
								<img src="assets/images/shape/shape_58.svg" alt="" class="shapes shape_01">
							</div>
							<!-- /.pr-column -->
						</div>
						<div class="col-lg-4 d-flex mt-35">
							<div class="pr-column w-100 d-flex flex-column">
								...
								<ul class="style-none package-feature mt-50 lg-mt-20 mb-35">
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> 60-day chat history</li>
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> Basic widget customization</li>
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> Ticketing system</li>
									<li><img src="assets/images/icon/cross.svg" alt="" class="icon"> Data security</li>
								</ul>
								<div class="mt-auto"><a href="#" class="btn-seven w-100">Subscribe Now</a></div>
							</div>
						...
						<div class="col-lg-4 d-flex mt-35">
							<div class="pr-column w-100 d-flex flex-column">
								...
								<ul class="style-none package-feature mt-50 lg-mt-20 mb-35">
									...
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> Basic widget customization</li>
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> Ticketing system</li>
									<li><img src="assets/images/icon/check.svg" alt="" class="icon"> Data security</li>
								</ul>
								<div class="mt-auto"><a href="#" class="btn-seven w-100">Subscribe Now</a></div>
								<img src="assets/images/shape/shape_58.svg" alt="" class="shapes shape_02">
							</div>
							<!-- /.pr-column -->
						</div>
					</div>
		...
		<div class="fancy-banner-seven position-relative z-1 mt-150 lg-mt-80">
			<div class="container">
				<img src="assets/images/shape/shape_59.svg" alt="" class="m-auto shape_01">
				<div class="row">
			...
			<div class="wrapper">
				<div class="container">
					<div class="position-relative">
							...
							<div class="row">
								...
								<div class="col-md-6 ms-auto">
									<form action="#" class="position-relative">
										...
										<button class="tran3s"><img src="assets/images/icon/icon_34.svg" alt="" class="m-auto"></button>
									</form>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xxl-3 col-xl-2 col-md-4 col-6">
								<div class="footer-nav mb-40">
									<ul class="footer-nav-link style-none">
										<li><a href="faq-v2.php">Faq’s</a></li>
						...
						<p class="copyright-text text-center m0"><strong class="text-white">@2024.</strong> All Right Reserved. </p>
					</div>
				</div>
			</div>
			<img src="assets/images/assets/bg_12.png" alt="" class="shapes bg_01">
			<img src="assets/images/shape/shape_56.svg" alt="" class="shapes shape_02">
			<img src="assets/images/shape/shape_57.svg" alt="" class="shapes shape_03">
		</div> <!-- /.footer-five -->
