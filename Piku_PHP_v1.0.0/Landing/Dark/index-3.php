...
<body>
	<div class="main-page-wrapper">
					...
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
							<ul class="d-flex align-items-center style-none">
								<li>
									<a href="login.php" class="login-btn-one fw-500 d-flex align-items-center tran3s"><img src="assets/images/icon/icon_18.svg" alt="" class="me-2"> <span>Login</span></a>
                                </li>
								<li class="d-none d-md-inline-block ms-4">
                                    <a href="contact-v1.php" class="btn-seven">Let’s Started</a>
                                </li>
							</ul>
						</div>
						<nav class="navbar navbar-expand-lg p0 order-lg-2">
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav align-items-lg-center">
									<li class="d-block d-lg-none"><div class="logo"><a href="index.php" class="d-block"><img src="assets/images/logo/logo_01.1.svg" alt=""></a></div></li>
									...
									<li class="d-md-none ps-3 pe-3 mt-20">
										<a href="contact-v1.php" class="btn-seven w-100">Let’s Started</a>
									</li>
								</ul>
							</div>
						</nav>
		...
		<div class="hero-banner-three z-2 position-relative pt-200 lg-pt-150">
			...
			<div class="media d-flex justify-content-center mt-100 lg-mt-60">
				<div class="position-relative">
					<img src="assets/images/assets/ils_11.png" alt="" >
					<img src="assets/images/assets/ils_11_01.png" alt="" class="shapes card_01">
					<img src="assets/images/assets/ils_11_02.png" alt="" class="shapes card_02">
				</div>
			</div>
            <img src="assets/images/shape/shape_29.png" alt="" class="shapes shape_01">
            <img src="assets/images/shape/shape_30.png" alt="" class="shapes shape_02">
		</div>
		<!-- /.hero-banner-three -->
			...
			<div class="container">
                <div class="row">
					...
					<div class="col-xxl-5 col-lg-6 ms-auto">
						...
						<a href="about-us-v3.php" class="btn-eight d-inline-flex align-items-center">More Details <img src="assets/images/icon/icon_19.svg" alt="" class="ms-3"></a>
					</div>
				</div>
					...
					<div class="counter-slider-one">
						<div class="item">
							<div class="card-style-four position-relative" style="background-image: url(assets/images/assets/bg_02.png);">
								<div class="d-flex justify-content-between align-items-center">
									<img src="assets/images/logo/p_logo_09.png" alt="">
									<img src="assets/images/shape/shape_31.svg" alt="">
								</div>
						...
						<div class="item">
							<div class="card-style-four position-relative" style="background-image: url(assets/images/assets/bg_03.png);">
								<div class="d-flex justify-content-between align-items-center">
									<img src="assets/images/logo/p_logo_10.png" alt="">
									<img src="assets/images/shape/shape_32.svg" alt="">
								</div>
						...
						<div class="item">
							<div class="card-style-four position-relative" style="background-image: url(assets/images/assets/bg_04.png);">
								<div class="d-flex justify-content-between align-items-center">
									<img src="assets/images/logo/p_logo_11.png" alt="">
									<img src="assets/images/shape/shape_33.svg" alt="">
								</div>
				...
				<div class="row align-items-center">
					<div class="col-xl-5 col-lg-6 order-lg-last">
						<div class="ps-xl-5 ms-xxl-3">
							...
							<a href="project-details.php" class="btn-seven">Get Started</a>
						</div>
					</div>
					<div class="col-xl-7 col-lg-6 col-md-10 m-auto">
						<div class="img-holder d-flex align-items-center justify-content-center md-mt-40">
							<img src="assets/images/assets/ils_12.png" alt="">
						</div>
					</div>
				</div>
				<div class="row align-items-center mt-150 xl-mt-100 lg-mt-60">
					<div class="col-xl-5 col-lg-6 order-lg-last">
						<div class="ps-xl-5 ms-xxl-3">
							...
							<a href="project-details.php" class="btn-seven">Learn More</a>
						</div>
					</div>
					<div class="col-xl-7 col-lg-6 col-md-10 m-auto">
						<div class="img-holder d-flex align-items-center justify-content-center md-mt-40">
							<img src="assets/images/assets/ils_13.png" alt="">
						</div>
					</div>
				</div>
				<div class="row align-items-center mt-150 xl-mt-100 lg-mt-60">
					...
					<div class="col-xl-7 col-lg-6 col-md-10 m-auto">
						<div class="img-holder d-flex align-items-center justify-content-center md-mt-40">
							<img src="assets/images/assets/ils_14.png" alt="">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row justify-content-between">
					<div class="col-xxl-3 col-lg-4">
						<div class="card-style-five text-center mb-25">
							<div class="icon d-flex align-items-center justify-content-center rounded-circle"><img src="assets/images/icon/icon_20.svg" alt=""></div>
		...
		<div class="block-feature-eleven z-1 bg-seven pt-150 lg-pt-80 mt-150 lg-mt-80">
					...
					<div class="col-lg-6">
						<div class="position-relative z-1 ps-xl-5">
							...
							<ul class="style-none d-flex flex-wrap align-items-center">
								<li class="me-4 mt-10"><a href="project-v3.php" class="btn-nine">Explore All</a></li>
								<li class="mt-10"><a href="project-details.php" class="btn-ten">Become an expert</a></li>
							</ul>
							<img src="assets/images/shape/shape_34.svg" alt="" class="shapes shape_01">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="slide-one pr-slide mt-100 lg-mt-50">
				<div class="pr-slider-one">
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_02.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_03.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_04.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_05.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_03.jpg" alt="" class="w-100"></a>
					</div>
			...
			<div class="slide-two pr-slide mt-50 lg-mt-30">
				<div class="pr-slider-one">
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_06.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_07.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_06.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_08.jpg" alt="" class="w-100"></a>
					</div>
					<div class="item">
						<a href="#" class="d-block"><img src="assets/images/media/img_09.jpg" alt="" class="w-100"></a>
					</div>
				</div>
			</div>
			<!-- /.slide-one -->
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-5 col-md-6 ms-auto">
						<div class="d-inline-flex position-relative z-1 sm-mt-40">
							<img src="assets/images/media/img_10.jpg" alt="" class="rounded-circle avatar-group">
							<img src="assets/images/media/img_11.jpg" alt="" class="rounded-circle avatar-group">
							<img src="assets/images/media/img_12.jpg" alt="" class="rounded-circle avatar-group">
							<img src="assets/images/media/img_13.jpg" alt="" class="rounded-circle avatar-group">
							<img src="assets/images/shape/shape_35.svg" alt="" class="shapes shape_01">
						</div>
						...
						<div class="item">
							<div class="feedback-block-two">
								...
								<div class="d-flex align-items-center justify-content-between">
									...
									<img src="assets/images/media/img_10.jpg" alt="" class="rounded-circle client-avatar">
								</div>
							</div>
							<!-- /.feedback-block-two -->
						</div>
						...
						<div class="item">
							<div class="feedback-block-two">
								...
								<div class="d-flex align-items-center justify-content-between">
									...
									<img src="assets/images/media/img_11.jpg" alt="" class="rounded-circle client-avatar">
								</div>
							</div>
							<!-- /.feedback-block-two -->
						</div>
						...
						<div class="item">
							<div class="feedback-block-two">
								...
								<div class="d-flex align-items-center justify-content-between">
									...
									<img src="assets/images/media/img_12.jpg" alt="" class="rounded-circle client-avatar">
								</div>
							</div>
							<!-- /.feedback-block-two -->
						</div>
		...
		<div class="pricing-section-two position-relative z-1 mt-170 xl-mt-150 lg-mt-80 pt-140 lg-pt-80 pb-150 xl-pb-120 lg-pb-80">
			...
			<div class="container">
				<div class="pr-table-wrapper position-relative z-1 mt-40" style="background-image: url(assets/images/assets/bg_06.png);">
					...
					<img src="assets/images/shape/shape_36.svg" alt="" class="shapes shape_01">
				</div>
				<!-- /.pr-table-wrapper -->
				...
				<div class="pr-table-wrapper position-relative z-1 mt-40" style="background-image: url(assets/images/assets/bg_07.png);">
					...
					<img src="assets/images/shape/shape_37.svg" alt="" class="shapes shape_01">
				</div>
				<!-- /.pr-table-wrapper -->
				...
				<div class="pr-table-wrapper position-relative z-1 mt-40" style="background-image: url(assets/images/assets/bg_08.png);">
					...
					<img src="assets/images/shape/shape_38.svg" alt="" class="shapes shape_01">
				</div>
				<!-- /.pr-table-wrapper -->
			</div>
		</div>
		...
		<div class="fancy-banner-three pt-150 lg-pt-80 pb-150 lg-pb-80 position-relative z-1">
			<div class="container">
				<img src="assets/images/logo/logo_06.svg" alt="" class="m-auto">
				<div class="row">
					<div class="col-xl-8 m-auto text-center">
						...
						<a href="pricing-v2.php" class="btn-eleven">Try it Now!</a>
					</div>
				</div>
			</div>
			<img src="assets/images/shape/shape_39.svg" alt="" class="shapes shape_01">
			<img src="assets/images/shape/shape_40.svg" alt="" class="shapes shape_02">
		</div>
		...
		<div class="footer-four">
			...
			<div class="container">
				<div class="bottom-footer">
					<p class="copyright-text text-center"><strong class="text-white">@2024.</strong> All Right Reserved. </p>
				</div>
			</div>
		</div> <!-- /.footer-four -->
